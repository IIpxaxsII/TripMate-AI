  ...
  return (
    ...
    >
      ...
      >
        ...
        <button className="absolute top-2 right-2 h-10 w-10 rounded-md bg-white/80 hover:bg-white backdrop-blur-sm flex items-center justify-center transition-colors z-10">
